...
export const botConfig = {
  ...
  presence: {
    ...
    activities: [
      {
        name: "EuropeMC Giveaways Hub", // required by Discord API, not shown in the client
        state: "Bot Made By _ziad1_ ",     // this is what people actually see
        type: 4,               // Custom
      },
    ],
  },
  ...
  giveaways: {
    ...
    allowedRoles: [1539256316827013150],
