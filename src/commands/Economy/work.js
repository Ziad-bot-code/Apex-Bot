...
const WORK_COOLDOWN = botConfig.economy?.cooldowns?.work ?? 30 * 60 * 100;
            ...
            if (cooldownActive) {
                if (extraWorkShifts > 0) {
                    ...
                    throw createError(
                        ...
                        `You're working too fast! Wait **${Math.floor(remaining / 60000)}h ${Math.floor((remaining % 60000) / 60000)}m** before working again.`,
